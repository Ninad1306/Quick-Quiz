...
class MultipleChoiceQuestion(BaseModel):
    ...
    options: List[Option] = Field(..., min_length=2, description='A list of possible options.')
    correct_answer: str = Field(..., description='The correct answer, which should be present in the options.')
...
class MultipleSelectQuestion(BaseModel):
    ...
    question_text: str = Field(..., min_length=1, description='The text of the multiple select question which can have 1 or more correct answers.')
    options: List[Option] = Field(..., min_length=2, description='A list of possible options.')
    correct_answer: List[str] = Field(..., min_length=1, description='The list of correct answers, which should be present in the options.')
    tags: List[str] = Field(..., min_length=1, description='The topic tags associated with question.')
