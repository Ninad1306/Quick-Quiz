    ...
    <Modal show={show} onClose={onClose} title="Enroll in Course">
      <div className="space-y-3">
        {courses.length === 0 ? (
          ...
          courses.map(course => (
            <div key={course.course_id} className="border border-gray-200 rounded-lg p-4 hover:border-blue-400 transition">
              ...
              <Button onClick={() => onEnroll(course.course_id)} variant="success" className="w-full mt-2">
                Enroll
              </Button>
            </div>
          ))
